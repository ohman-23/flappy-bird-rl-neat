...
from flappy_neat_rl.players.human_player import BirdHumanPlayer
from flappy_neat_rl.sprites import Bird, Button, Pipe
from flappy_neat_rl.utils import bird_to_pipe_distance
...
class NEATGenerationGame(Game):
    pass
    # print(
    #                 closest_bird.velocity,
    #                 bird_to_pipe_distance(closest_bird, bottom_closest_pipe),
    #                 bird_to_pipe_distance(closest_bird, top_closest_pipe),
    #             )
...
#             print(
#                 closest_bird.velocity,
#                 distance(closest_bird, bottom_closest_pipe),
#                 distance(closest_bird, top_closest_pipe),
#             )
#         if closest_bird.check_collision(bottom_closest_pipe) or closest_bird.check_collision(
#             top_closest_pipe
#         ):
...
#                 int(Config.PIPE_GAP / 2) + 100,
#                 int(Config.FLOOR_HEIGHT - Config.PIPE_GAP / 2 - 100),
#             )
...
#         GameInstance.ground_scroll = (
#             0
#             if abs(GameInstance.ground_scroll) > 35
